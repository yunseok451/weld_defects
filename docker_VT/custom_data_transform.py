...
input_directory = 'weld_vt/custom_vt/json' # '경로'/json
output_directory = 'weld_vt/custom_vt/labels' # '경로'/labels

# @@
#VT인 경우
class_mapping = {'normal': 0, 'porosity': 1, 'incomplete penetration': 2, 'lack of fusion': 3, 'undercut': 4}
#RT인 경우
